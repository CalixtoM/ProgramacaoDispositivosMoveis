...
export default function Home() {
  ...
  function irResultado(){
    navigation.navigate('Resultado', { nome: { resultadoNome }, idade: { resultadoIdade } });
  }
        ...
        <View style={styles.botao}>
          ...
          <Button
            ...
            navigation.navigate('Resultado', {
              paramKey1: nome, paramKey2: idade, paramKey3: sexo, paramKey4: escolaridade, paramKey5: limite, paramKey6: brasileiro
            })
          }
          />
